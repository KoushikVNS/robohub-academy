...
const teamMembers: TeamMember[] = [
  { id: 1, name: 'Sayan Das', role: 'Course Designer', image: sayanImg },
  { id: 2, name: 'Rupika Gupta', role: 'Content Creation', image: rupikaImg },
  { id: 3, name: 'Ritesh Yadav', role: 'Content Creation', image: riteshImg },
  ...
  { id: 7, name: 'Pranjal Singh', role: 'Design Lead', image: sayanImg }, // Using sayan as placeholder
];
