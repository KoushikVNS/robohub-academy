...
export function Walkthrough({
  ...
  const steps: Step[] = [{
    ...
    content: <div className="text-center">
          <h3 className="text-lg font-bold mb-2">🤖 Welcome to त्रिnetraCore</h3>
  ...
  return <Joyride steps={steps} run={run} stepIndex={stepIndex} continuous showProgress showSkipButton scrollToFirstStep disableOverlayClose callback={handleJoyrideCallback} styles={{
    options: {
      primaryColor: '#22c55e',
